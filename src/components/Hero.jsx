    ...
    <section className="relative h-[921px] flex items-center overflow-hidden bg-primary">
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12">
        <div className="max-w-3xl">
          <span className="text-primary-fixed-dim font-label tracking-[0.2em] text-sm uppercase mb-4 block">Winter Edition 2024</span>
          ...
          <button className="bg-surface text-primary font-label px-10 py-4 text-sm tracking-widest hover:bg-primary-fixed-dim transition-colors duration-300">
            BROWSE THE ARCHIVE
          </button>
        </div>
      </div>
