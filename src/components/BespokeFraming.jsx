...
const BespokeFraming = () => {
  return (
    <section className="py-32 bg-transparent text-white drop-shadow-md">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="order-2 lg:order-1">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-sm p-1 aspect-square border border-white/20">
              ...
              <div className="bg-white/10 backdrop-blur-sm p-1 aspect-square mt-12 border border-white/20">
          ...
          <div className="order-1 lg:order-2">
            <span className="text-white/70 font-label tracking-[0.3em] text-xs uppercase mb-6 block">Artisanal Craft</span>
            <h2 className="font-headline text-5xl mb-8">Bespoke Framing</h2>
            <p className="text-white/80 font-body leading-relaxed text-lg mb-12">Every photograph deserves a sanctuary. Our in-house workshop uses only museum-grade materials, hand-finished in Tromsø.</p>
            <div className="space-y-8 bg-white/5 backdrop-blur-md p-8 border border-white/10">
              <div className="flex items-center gap-6 border-b border-white/20 pb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70 mt-1">Light, natural, and timeless warmth.</p>
                </div>
              </div>
              <div className="flex items-center gap-6 border-b border-white/20 pb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70 mt-1">Modern, sharp, and focused precision.</p>
                </div>
              </div>
              <div className="flex items-center gap-6 pb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70 mt-1">Deep, rich character for legacy pieces.</p>
                </div>
              </div>
            </div>
          </div>
