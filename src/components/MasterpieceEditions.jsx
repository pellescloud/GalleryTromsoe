    ...
    <section className="py-24 bg-surface">
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center mb-20">
          <span className="text-outline font-label tracking-[0.3em] text-xs uppercase mb-4 block">The Shop</span>
          <h2 className="font-headline text-5xl text-primary">Masterpiece Editions</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          {/* Product 1 */}
          <div className="flex flex-col">
            <div className="bg-surface-container-low p-12 mb-8 group relative">
              <div className="aspect-[3/4] shadow-2xl transition-transform duration-500 group-hover:-translate-y-4">
              ...
              {/* Quick Action Hover */}
              <button className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-primary text-white font-label px-6 py-3 text-xs tracking-widest opacity-0 group-hover:opacity-100 transition-all duration-300">
                ADD TO CART
              </button>
            </div>
            <div className="flex justify-between items-start">
              <div>
                <h3 className="font-serif text-xl text-primary">The White Nomad</h3>
                <p className="text-sm text-on-surface-variant font-body mt-1">Giclée Print on Hahnemühle Paper</p>
              </div>
              <span className="font-body font-medium text-primary">€145.00</span>
            </div>
          </div>
          {/* Product 2 */}
          <div className="flex flex-col">
            ...
            <div className="flex justify-between items-start">
              <div>
                <h3 className="font-serif text-xl text-primary">Blue Hour Peaks</h3>
                <p className="text-sm text-on-surface-variant font-body mt-1">Limited Edition Framed</p>
              </div>
              <span className="font-body font-medium text-primary">€380.00</span>
            </div>
          </div>
          {/* Product 3 */}
          <div className="flex flex-col">
            ...
            <div className="flex justify-between items-start">
              <div>
                <h3 className="font-serif text-xl text-primary">Glacial Fragility</h3>
                <p className="text-sm text-on-surface-variant font-body mt-1">Framed in Black Metal</p>
              </div>
              <span className="font-body font-medium text-primary">€295.00</span>
            </div>
          </div>
        </div>
      </div>
