    ...
    <section className="py-32 bg-transparent text-white drop-shadow-md">
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center mb-28">
          <span className="text-white/60 font-label tracking-[0.3em] text-xs uppercase mb-4 block">The Shop</span>
          <h2 className="font-headline text-5xl">Masterpiece Editions</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-24">
          {/* Product 1 */}
          <div className="flex flex-col">
            <div className="bg-white/5 backdrop-blur-sm p-4 md:p-8 mb-10 group relative border border-white/10 hover:border-white/30 transition-colors duration-500">
              ...
              {/* Quick Action Hover */}
              <button className="absolute bottom-12 left-1/2 -translate-x-1/2 bg-white/10 backdrop-blur-md border border-white/30 text-white font-label px-8 py-4 text-xs tracking-widest opacity-0 group-hover:opacity-100 hover:bg-white/30 hover:border-white transition-all duration-300 shadow-xl">
                ADD TO CART
              </button>
            </div>
            <div className="flex justify-between items-start px-4">
              <div>
                ...
                <p className="text-sm text-white/70 font-body mt-2">Giclée Print on Hahnemühle Paper</p>
              </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-between items-start px-4">
              <div>
                ...
                <p className="text-sm text-white/70 font-body mt-2">Limited Edition Framed</p>
              </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-between items-start px-4">
              <div>
                ...
                <p className="text-sm text-white/70 font-body mt-2">Framed in Black Metal</p>
              </div>
