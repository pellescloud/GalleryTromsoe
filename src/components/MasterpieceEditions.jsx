    ...
    <section className="py-32 bg-[#faf9f6]">
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center mb-28">
          <span className="text-[#0B1221]/60 font-label tracking-[0.3em] text-xs uppercase mb-4 block">The Shop</span>
          <h2 className="font-headline text-5xl text-[#0B1221]">Masterpiece Editions</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-24">
          {/* Product 1 */}
          <div className="flex flex-col">
            <div className="bg-transparent p-4 md:p-8 mb-10 group relative border border-[#0B1221]/5 hover:border-[#0B1221]/10 transition-colors duration-500">
              <div className="aspect-[3/4] shadow-xl transition-transform duration-700 group-hover:-translate-y-2">
              ...
              {/* Quick Action Hover */}
              <button className="absolute bottom-12 left-1/2 -translate-x-1/2 bg-[#0B1221] text-white font-label px-8 py-4 text-xs tracking-widest opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-lg">
                ADD TO CART
              </button>
            </div>
            <div className="flex justify-between items-start px-4">
              <div>
                <h3 className="font-serif text-2xl text-[#0B1221]">The White Nomad</h3>
                <p className="text-sm text-[#0B1221]/70 font-body mt-2">Giclée Print on Hahnemühle Paper</p>
              </div>
              <span className="font-body font-medium text-[#0B1221]">€145.00</span>
            </div>
          </div>
          {/* Product 2 */}
          <div className="flex flex-col">
            ...
            <div className="flex justify-between items-start px-4">
              <div>
                <h3 className="font-serif text-2xl text-[#0B1221]">Blue Hour Peaks</h3>
                <p className="text-sm text-[#0B1221]/70 font-body mt-2">Limited Edition Framed</p>
              </div>
              <span className="font-body font-medium text-[#0B1221]">€380.00</span>
            </div>
          </div>
          {/* Product 3 */}
          <div className="flex flex-col">
            ...
            <div className="flex justify-between items-start px-4">
              <div>
                <h3 className="font-serif text-2xl text-[#0B1221]">Glacial Fragility</h3>
                <p className="text-sm text-[#0B1221]/70 font-body mt-2">Framed in Black Metal</p>
              </div>
              <span className="font-body font-medium text-[#0B1221]">€295.00</span>
            </div>
          </div>
        </div>
      </div>
