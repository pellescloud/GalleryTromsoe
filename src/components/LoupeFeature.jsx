        ...
        <div className="relative max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="w-full md:w-1/2 relative">
            ...
            <div className="absolute top-1/4 right-1/4 w-32 h-32 rounded-full border border-white/50 backdrop-blur-md flex items-center justify-center bg-white/20 shadow-xl scale-110">
              <p className="text-[10px] font-label text-[#0B1221] text-center leading-tight tracking-widest px-2">ULTRA-HD <br /> DETAIL</p>
            </div>
          </div>
          <div className="w-full md:w-1/2">
            <h2 className="font-headline text-4xl text-[#0B1221] mb-6">Museum Grade Giclée</h2>
            <p className="text-[#0B1221]/80 font-body mb-8 leading-relaxed">We print exclusively on archival 310gsm paper using 12-color pigment inks. The result is a depth of color that mimics the actual polar atmosphere.</p>
            <button className="bg-[#0B1221] text-white font-label px-12 py-5 tracking-[0.2em] text-xs hover:bg-[#1a1f2c] transition-all">LEARN OUR PROCESS</button>
          </div>
        </div>
      </div>
    </section>
