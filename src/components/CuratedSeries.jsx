      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div>
            ...
            <p className="text-primary/80 max-w-md font-body leading-relaxed">Specific perspectives on the North, hand-selected by our resident curators to bring the Arctic silence into your home.</p>
          </div>
          <a className="text-sm font-label tracking-widest uppercase border-b border-primary pb-1 hover:text-primary/70 transition-colors" href="#">View All Series</a>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Collection 1 */}
          <div className="group cursor-pointer">
            <div className="aspect-square overflow-hidden mb-6 relative border border-primary/20 bg-white/5 backdrop-blur-sm p-4">
              <img alt="Northern Lights" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/assets/unnamed.png" />
              <div className="absolute inset-4 bg-primary/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                <span className="text-primary font-label tracking-widest border border-primary px-6 py-2">EXPLORE</span>
              </div>
            </div>
            <h3 className="font-serif text-2xl">Northern Lights</h3>
            <p className="text-sm text-primary/70 mt-2">The Celestial Dance of the Aurora</p>
          </div>
          {/* Collection 2 */}
          <div className="group cursor-pointer">
            <div className="aspect-square overflow-hidden mb-6 relative border border-primary/20 bg-white/5 backdrop-blur-sm p-4">
            ...
            <p className="text-sm text-primary/70 mt-2">Arctic Urbanism & Polar Life</p>
          </div>
          {/* Collection 3 */}
          <div className="group cursor-pointer">
            <div className="aspect-square overflow-hidden mb-6 relative border border-primary/20 bg-white/5 backdrop-blur-sm p-4">
            ...
            <p className="text-sm text-primary/70 mt-2">Silent Monoliths of the Sea</p>
          </div>
        </div>
      </div>
    </section>
