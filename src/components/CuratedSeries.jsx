    ...
    <section className="py-24 bg-surface-container-low">
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div>
            <h2 className="font-headline text-4xl text-primary mb-4">Curated Series</h2>
            <p className="text-on-surface-variant max-w-md font-body leading-relaxed">Specific perspectives on the North, hand-selected by our resident curators to bring the Arctic silence into your home.</p>
          </div>
          <a className="text-sm font-label tracking-widest uppercase border-b border-primary pb-1 hover:text-outline transition-colors" href="#">View All Series</a>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group cursor-pointer">
            ...
            <h3 className="font-serif text-2xl text-primary">Northern Lights</h3>
            <p className="text-sm text-on-surface-variant mt-2">The Celestial Dance of the Aurora</p>
          </div>
          {/* Collection 2 */}
          <div className="group cursor-pointer">
            <div className="aspect-square overflow-hidden mb-6 relative">
            ...
            <h3 className="font-serif text-2xl text-primary">Tromsø City</h3>
            <p className="text-sm text-on-surface-variant mt-2">Arctic Urbanism & Polar Life</p>
          </div>
          {/* Collection 3 */}
          <div className="group cursor-pointer">
            <div className="aspect-square overflow-hidden mb-6 relative">
            ...
            <h3 className="font-serif text-2xl text-primary">Fjord Landscapes</h3>
            <p className="text-sm text-on-surface-variant mt-2">Silent Monoliths of the Sea</p>
          </div>
        </div>
      </div>
    </section>
